...
#define SABER_INDCPA_PUBLICKEYBYTES (SABER_POLYVECCOMPRESSEDBYTES + SABER_SEEDBYTES) //((3 * 320) + 32)=992
...
#define SABER_BYTES_CCA_DEC   (SABER_POLYVECCOMPRESSEDBYTES + SABER_RECONBYTES_KEM) //1088 /* Second part is for Targhi-Unruh */
